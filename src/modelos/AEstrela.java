...
public class AEstrela {
    ...
    public void solucionar(String nomeA, String nomeB) {
        ...
        Aresta arestaMenor = new Aresta(0, nodoInicial, nodoInicial.getNome());
    ...
    private void addFilhos(Aresta arestaPai) {
        ...
        while (arestasIterator.hasNext()) {
            ...
            String caminho = arestaPai.getCaminho() + ", " + nodo.getNome(); //caminho que foi percorrido até este nó
            Aresta novaAresta = new Aresta(novoPeso, nodo, caminho);
            ...
            else if (!novaAresta.getNodo().isFechado()) //else if(!novaAresta.getNodo().isFechado() && novaAresta.getNodo().isAberto()) possuem a mesma funcionalidade neste contexto
            {
